...
class TestWindow:
    ...
    def test_add(self):
        standard_test_add_device(TestWindow.standard_data)
    ...
    def test_change_update_time(self):
        ...
        standard_test_modify_device(TestWindow.standard_data, modify_data, _check)
    ...
    def test_change_update_time_negative(self):
        ...
        device_id = create_device(TestWindow.standard_data)
    ...
    def test_connect(self):
        standard_test_connect_device(TestWindow.standard_data)

    def test_disconnect(self):
        standard_test_disconnect_device(TestWindow.standard_data)

    def test_reboot(self):
        standard_test_reboot_device(TestWindow.standard_data)
    ...
    def test_power_off(self):
        standard_test_power_off_device(TestWindow.standard_data)
    ...
    def test_execute_on(self):
        ...
        standard_execute_action_device(TestWindow.standard_data, command, check_execute("on"))

    def test_execute_off(self):
        command = {
            "state": "off"
        }
        standard_execute_action_device(TestWindow.standard_data, command, check_execute("off"))

    def test_metrics(self):
        standard_metrics_test(TestWindow.standard_data)
